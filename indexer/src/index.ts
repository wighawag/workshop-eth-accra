...
const WorkshopEthAccraIndexerProcessor: JSProcessor<MergedAbis<typeof contractsInfo.contracts>, Data> = {
...
export const createProcessor = fromJSProcessor(() => WorkshopEthAccraIndexerProcessor);
